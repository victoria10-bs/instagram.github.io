...
const getAllPosts = () => {
    ...
    if (post) {
        ...
        post.reverse().map((item) => {
            ...
            <img src="${ item.pphoto }" class="post-image" alt=""></img>
            <div class="post-content">
                <div class="reaction-wrapper">
                    <img src="assets/img/like.PNG" class="icon" alt=""></img>
                    <img src="assets/img/comment.PNG" class="icon" alt=""></img>
                    <img src="assets/img/send.PNG" class="icon" alt=""></img>
                    <img src="assets/img/save.PNG" class="save icon" alt=""></img>
                </div>
            ...
            <div class="comment-wrapper">
                <img src="assets/img/smile.PNG" class="icon" alt=""></img>
